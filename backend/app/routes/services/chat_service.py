...
4. If the user asks for a summary, provide a proper summary of the whole content instead of just repeating the first few lines.
...
"""
    ...
    try:
        response = client.responses.create(
            model="gpt-4o-mini",
            instructions="Answer clearly and accurately using only the provided document context.",
            input=prompt,
        )
